...
public class SuggerDefinitionDepartment extends Definition {
    
    @Getter
    private static final SuggerDefinitionDepartment instance = new SuggerDefinitionDepartment();
    ...
    private static final OptionClass<?> optionClass = new OptionClass<OptionProductline>() {
        ...
        protected Collection<OptionProductline> queryOptions(Collection<OptionProductline> values) throws Exception {
            ...
            return ClassUtil.getSingltonInstance(FieldDepartment.class).queryDynamicValues(optionValues.toArray());
        }
