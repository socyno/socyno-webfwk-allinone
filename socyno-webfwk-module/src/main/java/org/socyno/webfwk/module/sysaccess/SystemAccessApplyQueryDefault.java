...
public class SystemAccessApplyQueryDefault extends AbstractStateFormQuery {
    ...
    @Attributes(title = "状态", type = SystemAccessApplyFormDetail.FieldOptionsState.class , position = 1002)
    ...
    private AbstractSqlStatement buildWhereSql() {
        ...
        if(StringUtils.isNotBlank(getState())){
            ...
            sqlstmt.append(String.format(" and a.%s = ?", SystemAccessApplyService.getInstance().getFormStateField()));
        }
