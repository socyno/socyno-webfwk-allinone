...
public class ReleaseMobileOnlineSimpleForm implements AbstractStateForm, ReleaseMobileOnlineWithAppStore {
    
    public static class FieldOptionsState extends FieldType {
        @Override
        public List<? extends FieldOption> getStaticOptions() {
            return ReleaseMobileOnlineService.DEFAULT.getStates();
        }
    ...
    @Attributes(title = "状态", readonly = true, type = ReleaseMobileOnlineDetailFrom.FieldOptionsState.class)
