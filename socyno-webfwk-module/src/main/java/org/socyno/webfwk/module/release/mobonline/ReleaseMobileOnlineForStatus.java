...
public class ReleaseMobileOnlineForStatus extends BasicStateForm {
    ...
    @Attributes(title = "当前状态", required = true, position = 1003, type = ReleaseMobileOnlineDetailFrom.FieldOptionsAppStoreStatus.class)
