...
@Setter
@ToString
public class DataChartSimpleForm implements AbstractStateForm {
    ...
    @Attributes(title = "图表类型" , type = DataChartCreateForm.FieldChartType.class)
    private OptionDynamicStandard chartType;

    @Attributes(title = "绘图参数")
    private String chartParams;

    @Attributes(title = "求和选择", type = DataChartCreateForm.FieldOptionSum.class)
