...
public class SystemAccessApplySimple implements AbstractStateForm,  SystemAccessApplyWithSubSystems {

    public static class FieldOptionsState extends FieldType {
        
        @Override
        public List<? extends FieldOption> getStaticOptions() {
            return SystemAccessApplyService.DEFAULT.getStates();
        }
    ...
    @Attributes(title = "状态", readonly = true, type = SystemAccessApplyDetail.FieldOptionsState.class)
