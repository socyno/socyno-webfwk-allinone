...
public class ReleaseMobileConfigSimple implements AbstractStateForm {

    public static class FieldOptionsState extends FieldType {
        @Override
        public List<? extends FieldOption> getStaticOptions() {
            return ReleaseMobileConfigService.DEFAULT.getStates();
        }
    ...
    @Attributes(title = "状态", readonly = true, type = ReleaseMobileConfigDetail.FieldOptionsState.class)
    ...
    @Attributes(title = "系统类型", required = true, position = 1002, type = ReleaseMobileConfigDetail.FieldOptionsAppStoreType.class)
