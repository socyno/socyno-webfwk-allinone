...
import org.socyno.webfwk.state.module.notify.SystemNotifyRecordSimple.FieldOptionsResult;
import org.socyno.webfwk.state.module.notify.SystemNotifyRecordSimple.FieldOptionsState;
...
public class SystemNotifyRecordDefaultQuery extends AbstractStateFormQuery {
    ...
    public SystemNotifyRecordDefaultQuery(long page, int limit) {
        setPage(page);
        setLimit(limit);
    }
