...
import org.socyno.webfwk.state.module.notify.SystemNotifyTemplateSimple.FieldOptionsState;
...
public class SystemNotifyTemplateForCreation implements AbstractStateForm {
    @Attributes(title = "编号")
    private Long id;
