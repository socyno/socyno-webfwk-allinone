...
public abstract class AbstractStateChoice {
    ...
    private static class EventContext {
        ...
        private AbstractStateForm originForm;
        
        private AbstractStateFormService<?> service;
        
        EventContext(AbstractStateFormService<?> service, String event, AbstractStateForm originForm) {
            this.event = event;
    ...
    private void setEventContext(AbstractStateFormService<?> service, String event, AbstractStateForm originForm) {
    ...
    protected AbstractStateForm getContextFormOrigin() {
    ...
    public String getTargetState(@NonNull AbstractStateForm form, AbstractStateForm originForm,
