...
public class RestClient {
     ...
     */
    public RestClient(String url) throws URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    public RestClient(String url, String charset) throws URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    public RestClient(String url, int timeoutMS) throws URISyntaxException {
     ...
     * @throws URISyntaxException
     */
    public RestClient(String url, int timeoutMS, String charset)
            throws URISyntaxException  {
    ...
    public String getCharset() {
        return CommonUtil.ifBlank(charset, HTTP_CHARSET_DEFAULT);
    }
    ...
    private R request(Method method, String pathQuery, Map<String, Object> query, Object data,
        ...
        if (data instanceof QueryMapData) {
            ...
            body = CommonUtil.toJson(data).getBytes(getCharset());
        ...
        try {
            resp = HttpUtil.request(fullUrl, CommonUtil.ifNull(method, Method.GET).name(), query, headers, body,
                    timeoutMS);
...
//
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T get(Type clazz, String path, Map<String, Object> query, Map<String, Object> headers, boolean isCheckStatus)
            throws IOException {
...
//
    ...
    protected R transform(String responseText, HttpResponse response) {
        return CommonUtil.fromJson(responseText, R.class);
    }
     ...
     * @return
     */
    protected <T> T fromObject(Object data, Type clazz) {
