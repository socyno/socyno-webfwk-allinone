...
import com.weimob.webfwk.state.util.StateFormDisplayScheduled;
import com.weimob.webfwk.state.util.StateFormDynamicForm;
import com.weimob.webfwk.state.util.StateFormSimpleChoice;
import com.weimob.webfwk.state.util.StateFormActionDefinition.EventType;
import com.weimob.webfwk.util.tool.ClassUtil;
import com.weimob.webfwk.util.tool.ClassUtil.FieldAttribute;
...
@Slf4j
@ToString
public abstract class AbstractStateAction<S extends AbstractStateFormBase, F extends AbstractStateFormInput, T> {
     ...
     */
    @SuppressWarnings("unchecked")
    public final T handleForm(AbstractStateFormService<S> service, String contextEvent, String event, S originForm, AbstractStateFormInput form, String message) throws Exception {
     ...
     */
    @SuppressWarnings("unchecked")
    public final T handleForm(AbstractStateFormService<S> service, String event, S originForm, AbstractStateFormInput form, String message) throws Exception {
     ...
     */
    @SuppressWarnings("unchecked")
    public final void postForm(AbstractStateFormService<S> service, String event, Object result, S originForm, AbstractStateFormInput form, String message) {
    ...
    public String getDynamicFormDefinition(String event, S form) throws Exception {
        return ClassUtil.classToJson(StateFormBasicInput.class).toString();
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public Class<AbstractStateFormBase> getOriginTypeClass() {
        return (Class<AbstractStateFormBase>)ClassUtil.getActualParameterizedType(this.getClass(), AbstractStateAction.class, 0);
    }
